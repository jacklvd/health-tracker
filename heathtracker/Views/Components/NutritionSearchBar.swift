...
struct NutritionSearchBar: View {
    ...
    private let placeholders = [
        "Search for foods... (e.g., apple, chicken breast)",
        "Try '1 cup rice' or '100g salmon'",
        "Search '1 medium banana' or '2 slices bread'",
        "Enter foods like 'grilled chicken' or 'avocado'"
    ]
    ...
    private let quickSearchSuggestions = [
        "apple", "banana", "chicken breast", "rice", "broccoli", "salmon", "eggs", "oatmeal"
    ]
